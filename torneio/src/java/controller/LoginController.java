...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Jogador newUser = new Jogador();
        newUser.setApelido(this.user);
        newUser.setSenha(this.pass);
        ...
        if(newUser.isLogged()) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("</head>");
                out.println("<body>");
                //out.println("<h1>"+ newUser.getApelido() +"</h1>");
                //out.println("<h1>"+ newUser.getSenha() +"</h1>");
                out.println("<script>");
